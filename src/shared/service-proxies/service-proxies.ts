...
export class CarsServiceProxy {
     ...
     * @param maxStockCountFilter (optional) 
     * @param minStockCountFilter (optional) 
     * @param maxPriceFilter (optional) 
     * @param minPriceFilter (optional) 
     * @param bodyTypeFilter (optional) 
     * @param maxReleaseDateFilter (optional) 
     * @param minReleaseDateFilter (optional) 
     * @param isAvailableFilter (optional) 
     ...
     * @return Success
     */
    getAll(filter: string | null | undefined, nameFilter: string | null | undefined, maxStockCountFilter: number | null | undefined, minStockCountFilter: number | null | undefined, maxPriceFilter: number | null | undefined, minPriceFilter: number | null | undefined, bodyTypeFilter: string | null | undefined, maxReleaseDateFilter: moment.Moment | null | undefined, minReleaseDateFilter: moment.Moment | null | undefined, isAvailableFilter: number | null | undefined, brandNameFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfGetCarForView> {
        let url_ = this.baseUrl + "/api/services/app/Cars/GetAll?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (nameFilter !== undefined)
            url_ += "NameFilter=" + encodeURIComponent("" + nameFilter) + "&"; 
        if (maxStockCountFilter !== undefined)
            url_ += "MaxStockCountFilter=" + encodeURIComponent("" + maxStockCountFilter) + "&"; 
        if (minStockCountFilter !== undefined)
            url_ += "MinStockCountFilter=" + encodeURIComponent("" + minStockCountFilter) + "&"; 
        ...
        if (bodyTypeFilter !== undefined)
            url_ += "BodyTypeFilter=" + encodeURIComponent("" + bodyTypeFilter) + "&"; 
        if (maxReleaseDateFilter !== undefined)
            url_ += "MaxReleaseDateFilter=" + encodeURIComponent(maxReleaseDateFilter ? "" + maxReleaseDateFilter.toJSON() : "") + "&"; 
        if (minReleaseDateFilter !== undefined)
        ...
        if (isAvailableFilter !== undefined)
            url_ += "IsAvailableFilter=" + encodeURIComponent("" + isAvailableFilter) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfGetCarForView>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetCarForView>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfGetCarForView> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfGetCarForView.fromJS(resultData200) : new PagedResultDtoOfGetCarForView();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfGetCarForView>(<any>null);
    }
     ...
     * @return Success
     */
    getCarsToExcel(filter: string | null | undefined, nameFilter: string | null | undefined, maxStockCountFilter: number | null | undefined, minStockCountFilter: number | null | undefined, maxPriceFilter: number | null | undefined, minPriceFilter: number | null | undefined, bodyTypeFilter: string | null | undefined, maxReleaseDateFilter: moment.Moment | null | undefined, minReleaseDateFilter: moment.Moment | null | undefined, isAvailableFilter: number | null | undefined, brandNameFilter: string | null | undefined): Observable<FileDto> {
...
export class PersonsServiceProxy {
     ...
     * @return Success
     */
    getAll(filter: string | null | undefined, nameFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfGetPersonForView> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfGetPersonForView>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetPersonForView>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfGetPersonForView> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfGetPersonForView.fromJS(resultData200) : new PagedResultDtoOfGetPersonForView();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfGetPersonForView>(<any>null);
    }
     ...
     * @return Success
     */
    getPersonsToExcel(filter: string | null | undefined, nameFilter: string | null | undefined): Observable<FileDto> {
...
export class PagedResultDtoOfGetCarForView implements IPagedResultDtoOfGetCarForView {
    totalCount!: number | undefined;
    items!: GetCarForView[] | undefined;

    constructor(data?: IPagedResultDtoOfGetCarForView) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(GetCarForView.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfGetCarForView {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfGetCarForView();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfGetCarForView {
    totalCount: number | undefined;
    items: GetCarForView[] | undefined;
}

export class GetCarForView implements IGetCarForView {
    car!: CarDto | undefined;

    constructor(data?: IGetCarForView) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetCarForView {
        data = typeof data === 'object' ? data : {};
        let result = new GetCarForView();
        result.init(data);
        return result;
    }
...
export interface IGetCarForView {
    car: CarDto | undefined;
}
...
export class PagedResultDtoOfGetPersonForView implements IPagedResultDtoOfGetPersonForView {
    totalCount!: number | undefined;
    items!: GetPersonForView[] | undefined;

    constructor(data?: IPagedResultDtoOfGetPersonForView) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(GetPersonForView.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfGetPersonForView {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfGetPersonForView();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfGetPersonForView {
    totalCount: number | undefined;
    items: GetPersonForView[] | undefined;
}

export class GetPersonForView implements IGetPersonForView {
    person!: PersonDto | undefined;

    constructor(data?: IGetPersonForView) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetPersonForView {
        data = typeof data === 'object' ? data : {};
        let result = new GetPersonForView();
        result.init(data);
        return result;
    }
...
export interface IGetPersonForView {
    person: PersonDto | undefined;
}
